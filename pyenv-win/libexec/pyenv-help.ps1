...
Write-Output "   update       Update the cached version DB from the repository"
Write-Output "   upgrade      Update pyenv-win itself to the latest version"
Write-Output "   rehash       Rehash pyenv shims (run this after installing executables)"
Write-Output "   cache        List, clear, or sync the installer cache"
