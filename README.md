...
This project was forked from [rbenv-win][3] and modified for [pyenv][1]. Version 4.0 is a complete rewrite — all legacy VBScript and Batch files have been replaced with PowerShell 7 scripts.
