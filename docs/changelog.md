...
### Miscellaneous
- Update cached versions to v4.3.3 by @github-actions[bot]

[4.3.3]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.3.2...v4.3.3
...
### Miscellaneous
- Update cached versions to v4.3.2 by @github-actions[bot]

[4.3.2]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.3.1...v4.3.2
...
### Miscellaneous
- Update cached versions to v4.3.1 by @github-actions[bot]

[4.3.1]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.3.0...v4.3.1
...
### Bug Fixes
- Ensure pip shims are always created on install by @nikolasd in [#6](https://github.com/Satori-Analytics/pyenv-win/pull/6)

[4.3.0]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.12...v4.3.0
...
### Miscellaneous
- Update cached versions to v4.2.12 by @github-actions[bot]

[4.2.12]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.11...v4.2.12
...
### Miscellaneous
- Update cached versions to v4.2.11 by @github-actions[bot]

[4.2.11]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.10...v4.2.11
...
### Miscellaneous
- Update cached versions to v4.2.10 by @github-actions[bot]

[4.2.10]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.9...v4.2.10
...
### Miscellaneous
- Update cached versions to v4.2.9 by @github-actions[bot]

[4.2.9]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.8...v4.2.9
...
### Miscellaneous
- Update cached versions to v4.2.8 by @github-actions[bot]

[4.2.8]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.7...v4.2.8
...
### Miscellaneous
- Update cached versions to v4.2.7 by @github-actions[bot]

[4.2.7]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.6...v4.2.7
...
### Miscellaneous
- Update cached versions to v4.2.6 by @github-actions[bot]

[4.2.6]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.5...v4.2.6
...
### Miscellaneous
- Update cached versions to v4.2.5 by @github-actions[bot]

[4.2.5]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.4...v4.2.5
...
### Miscellaneous
- Update cached versions to v4.2.4 by @github-actions[bot]

[4.2.4]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.3...v4.2.4
...
### Miscellaneous
- Update cached versions to v4.2.3 by @github-actions[bot]

[4.2.3]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.2...v4.2.3
...
### Documentation
- Update license information in README.md by @nikolasd

### Miscellaneous
- Update cached versions to v4.2.2 by @github-actions[bot]
- Update workflow configurations by @nikolasd

[4.2.2]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.1...v4.2.2
...
### CI/CD
- Add version to publish workflow run name by @nikolasd

### Miscellaneous
- Update cached versions to v4.2.1 by @github-actions[bot]
- Update GitHub Actions configuration for version updates by @nikolasd
- Set git-town feature sync strategy to rebase by @nikolasd

[4.2.1]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.2.0...v4.2.1
...
### Bug Fixes
- Use PAT for changelog push to bypass branch protection by @nikolasd

### CI/CD
- Restrict Pester triggers to pyenv-win and tests paths by @nikolasd

### Miscellaneous
- Remove obsolete __pycache__ exclusion from release zip by @nikolasd

### Refactor
- Reorder publish steps to include updated changelog in zip by @nikolasd

### Testing
- Migrate test infrastructure from pytest to Pester 5 by @nikolasd in [#4](https://github.com/Satori-Analytics/pyenv-win/pull/4)

[4.2.0]: https://github.com/Satori-Analytics/pyenv-win/compare/v4.1.0...v4.2.0
